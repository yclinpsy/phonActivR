...
#   Figure 10 — Cross-linguistic comparison        [phonActivR + ggplot2]
#   Figure 11 — Cohort vs. rhyme benchmark         [phonActivR + ggplot2]
#   Figure 12 — Multi-parameter sensitivity grid   [phonActivR + ggplot2]
#   Figure 13 — Parameter recovery                 [phonActivR + ggplot2]
#   Figure 14 — Goodness-of-fit AIC comparison     [phonActivR + ggplot2]
#
# INSTRUCTIONS:
...
# --- Figure 12: Multi-parameter Sensitivity Analysis ---------------------------
message("[7/11] Figure 12: Multi-parameter sensitivity...")
...
fig12 <- ggplot(sens_df, aes(x = delta, y = peak_asym, fill = delta)) +
...
ggsave("figures/Figure12_sensitivity_grid.png", fig12,
...
# --- Figure 13: Parameter Recovery -------------------------------------------
message("[9/11] Figure 13: Parameter recovery...")
set.seed(1234)
...
fig13 <- ggplot(rec_df, aes(x = factor(delta), y = count)) +
...
ggsave("figures/Figure13_parameter_recovery.png", fig13,
       width = 10, height = 6, dpi = 300)
       width = 10, height = 6)

# --- Figure 14: Goodness-of-Fit AIC ------------------------------------------
message("[10/11] Figure 14: Goodness-of-fit AIC...")
...
fig14 <- ggplot(gof, aes(x = factor(delta), y = delta_aic)) +
...
ggsave("figures/Figure14_goodness_of_fit.png", fig14,
...
message("  Fig 12  — Multi-parameter sensitivity grid")
message("  Fig 11 — Cohort vs. rhyme qualitative benchmark")
message("  Fig 13 — Parameter recovery test")
message("  Fig 14 — Goodness-of-fit AIC comparison")
message("\nSession info:")
sessionInfo()

# --- Figure 10: Cross-Linguistic Comparison -----------------------------------
message("[11/11] Figure 10: Cross-linguistic comparison...")
...
fig12 <- cross$plot
ggsave("figures/Figure10_cross_linguistic.png", fig12,
       width = 16, height = 6.5, dpi = 300)
       width = 16, height = 6.5)
message("  Fig 10 — Cross-linguistic grain-size comparison")
